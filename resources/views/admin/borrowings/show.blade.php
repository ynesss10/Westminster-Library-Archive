...
@section('content')
    ...
    <div class="max-w-6xl mx-auto px-6 py-12">
            ...
            <div class="p-6 md:p-8">
                ...
                @if($borrowing->status === 'pending')
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        {{-- Approve Button --}}
                        <button type="button" onclick="openApproveModal()" class="w-full sm:w-auto
                                       bg-[#101d33]
                                       text-white
                                       px-7 py-3
                                       text-[10px]
                        ...
                        {{-- Reject Button --}}
                        <button type="button" onclick="openRejectModal()" class="w-full sm:w-auto
                ...
                @elseif(in_array($borrowing->status, ['approved', 'borrowed']))
                    ...
                    <button type="button" onclick="openReturnModal()" class="bg-[#101d33]
                                   text-white
                                   px-7 py-3
                                   text-[10px]
                                   tracking-widest
        ...
        <div class="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <a href="{{ route('admin.borrowings.index') }}" class="text-center
            ...
            <a href="{{ route('admin.books.show', $borrowing->book) }}" class="text-center
    ...
    @if($borrowing->status === 'pending')
        ...
        <div id="approveModal" class="hidden fixed inset-0 bg-black/20 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full">
                ...
                <p class="text-sm text-gray-600 mb-6">
                    Are you sure you want to approve this borrowing request for <span
                        class="font-medium text-[#101d33]">{{ $borrowing->user->name }}</span>?
                </p>

                <div class="flex gap-3">
                    <button type="button" onclick="closeApproveModal()" class="flex-1
                               border border-gray-300
                               text-gray-600
                               px-4 py-2
                               text-[10px]
        ...
        <div id="rejectModal" class="hidden fixed inset-0 bg-black/20 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full">
                ...
                <div class="flex gap-3">
                    <button type="button" onclick="closeRejectModal()" class="flex-1
                               border border-gray-300
                               text-gray-600
                               px-4 py-2
                               text-[10px]
    ...
    @if(in_array($borrowing->status, ['approved', 'borrowed']))
        ...
        <div id="returnModal" class="hidden fixed inset-0 bg-black/20 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full">
                <h3 class="font-serif text-2xl text-[#101d33] mb-2">
                    Process Return?
                </h3>
                ...
                <p class="text-sm text-gray-600 mb-6">
                    Are you sure you want to process the return of this book from <span
                        class="font-medium text-[#101d33]">{{ $borrowing->user->name }}</span>?
                </p>

                <div class="flex gap-3">
                    <button type="button" onclick="closeReturnModal()" class="flex-1
                               border border-gray-300
                               text-gray-600
                               px-4 py-2
                               text-[10px]
                    ...
                    <form action="{{ route('admin.borrowings.return', $borrowing) }}" method="POST" class="flex-1">
                        @csrf
                        <button type="submit" class="w-full
                                   bg-[#101d33]
                                   text-white
